...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontFamily: FONT_FAMILY, fontSize: 16, fontWeight: "600", color: "#000", marginBottom: 8 },
  sectionSubtitle: { fontFamily: FONT_FAMILY, fontSize: 13, color: "#666", marginBottom: 4 },
  recommendedCard: {
    backgroundColor: "#FFF",
    borderRadius: 16,
    padding: 16,
  ...
  recommendedText: { fontFamily: FONT_FAMILY, fontSize: 15, fontWeight: "600", color: "#333", flex: 1, lineHeight: 22 },
  arrowIcon: { fontSize: 24, color: PRIMARY_COLOR, marginLeft: 8 },
  recommendedBadges: { flexDirection: "row", marginBottom: 10 },
  badgeStartFirst: { backgroundColor: "#70E3BB", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, marginRight: 8 },
  badgeWeak: { backgroundColor: "#FFAEAF", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  badgeText: { fontFamily: "Poppins-Medium", color: "#000000", fontSize: 10, letterSpacing: 0.5 },
});
