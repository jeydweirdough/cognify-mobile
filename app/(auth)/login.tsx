...
const styles = StyleSheet.create({
  ...
  input: { height: 50, borderWidth: 1, borderColor: THEME.borderColor, borderRadius: 8, paddingHorizontal: 15, fontSize: 14, color: '#000', backgroundColor: '#fff' },
  inputError: { borderColor: THEME.errorRed, borderWidth: 1 },
  errorText: { color: THEME.errorRed, fontSize: 12, marginTop: 5, marginLeft: 4, fontWeight: '500' },
  passwordContainer: { flexDirection: 'row', alignItems: 'center', height: 50, borderWidth: 1, borderColor: THEME.borderColor, borderRadius: 8, backgroundColor: '#fff' },
  passwordInput: { flex: 1, height: '100%', paddingHorizontal: 15, fontSize: 14, color: '#000' },
  eyeIcon: { padding: 10 },
  button: { backgroundColor: THEME.buttonPurple, height: 52, borderRadius: 26, justifyContent: 'center', alignItems: 'center', marginTop: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4, elevation: 3 },
  buttonDisabled: { opacity: 0.7 },
  buttonText: { fontSize: 16, color: THEME.white, fontWeight: '600' },
  footer: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 30 },
  footerText: { fontSize: 14, color: '#000' },
  signUpLink: { fontSize: 14, color: '#000', fontWeight: 'bold', textDecorationLine: 'underline' },
});